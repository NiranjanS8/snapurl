...
public class AuthController {
    ...
    public AuthController(UserService userService, RateLimitGuard rateLimitGuard, ClientIpResolver clientIpResolver) {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest registerRequest, HttpServletRequest request) {
        ...
        return rateLimitGuard.withHeaders(ResponseEntity.ok(), rateLimitResult).body("User Registered Successfully");
    }
    ...
    public ResponseEntity<ForgotPasswordResponse> forgotPassword(@Valid @RequestBody ForgotPasswordRequest forgotPasswordRequest, HttpServletRequest request) {
        ...
        return rateLimitGuard.withHeaders(ResponseEntity.ok(), rateLimitResult).body(userService.requestPasswordReset(forgotPasswordRequest.getEmail()));
    }
    ...
    public ResponseEntity<?> resetPassword(@Valid @RequestBody ResetPasswordRequest resetPasswordRequest, HttpServletRequest request) {
        ...
        return rateLimitGuard.withHeaders(ResponseEntity.ok(), rateLimitResult).body("Password reset successfully");
    }
