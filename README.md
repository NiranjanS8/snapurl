...
SnapURL is positioned as a backend-heavy full-stack project with practical distributed-system concepts:
...
- rate limiting
- query design
- concurrency-aware update paths

For a fresher backend profile, that gives you a much stronger story than a typical URL shortener or dashboard CRUD app.
